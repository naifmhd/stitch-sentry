# Features & Plans (config/features.php)

Paste into: `config/features.php`
...
- Use `FeatureGate` to read this config and enforce limits server-side.
- Credits are deducted with idempotency keys to avoid double-charges on retries.
